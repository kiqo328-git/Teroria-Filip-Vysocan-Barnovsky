...
BLOCKS = {
    ...
    5: {"name": "vegetation", "solid": False, "variants": 6, "file": None},
}
...
NPC_SPAWN_FREQ = 1 # VYŠŠIA frekvencia (0.05) - pre rýchle zmeny šumu (žiadne série)
NPC_SPAWN_THRESHOLD = 0.05 # ZNÍŽENÝ prah (0.80) - pre väčšiu šancu na spawn, ak je to možné.
